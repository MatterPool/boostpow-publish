...
function difficultyConsistency(o) {
	...
	if (!Helpers.isStrictBool(o.locked)) o.locked = false;
...
function normalizeDifficulty(opts) {
	...
	if (Helpers.isStrictBool(opts.difficulty)) {
		return o;
	}
	// When object, overrides defaults and return
	else if (Helpers.hasObjProp(opts.difficulty)) {
		o = Object.assign({}, o, opts.difficulty);
		return difficultyConsistency(o);
	}

	o.min = opts.minDiff > 0 ? opts.minDiff : o.min || 1;
	o.max = opts.maxDiff > o.min ? opts.maxDiff : o.max || 40;
	o.initial = opts.initialDiff >= o.min && opts.initialDiff <= o.max ? opts.initialDiff : o.initial || o.min;
	o.multiplier = opts.diffMultiplier > 0 ? opts.diffMultiplier : o.multiplier || 0.00002;
	o.locked = Helpers.isStrictBool(opts.lockDiff) ? opts.lockDiff : false;
